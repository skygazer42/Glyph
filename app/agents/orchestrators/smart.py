...
from app.agents.router.intent_router import IntentRouterAgent, IntentClassification
from app.agents.specialized.chat_agent import ChatAgent
from app.agents.specialized.calculation_agent import CalculationAgent
from app.agents.specialized.clarifier import ClarifierAgent
from app.agents.retrieval.vector_retriever import VectorRetrieverAgent
from app.agents.retrieval.graph_retriever import GraphRetrieverAgent
from app.agents.analysis.policy_analyzer import PolicyAnalyzerAgent
from app.agents.analysis.policy_comparator import PolicyComparatorAgent
from app.agents.generation.answer_generator import AnswerGeneratorAgent
from app.agents.common import session_store
...
class SmartOrchestrator:
    ...
    async def _retrieve_documents(self, user_query: UserQuery, top_k: int = 5) -> List:
        ...
        if self.kb_agents["knowledge_retriever"]:
            from app.models.base import RetrievalRequest
