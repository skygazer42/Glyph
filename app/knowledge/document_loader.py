...
迁移自 app.utils.document_loader，使文档加载逻辑归拢在 app.knowledge 下，
供 LightRAG 种子导入和离线脚本复用。
"""
...
class DocumentLoader:
    ...
    def _extract_title(self, content: str) -> Optional[str]:
        ...
        for line in lines:
            ...
            if len(line) > 10 and len(line) < 100 and any(
                keyword in line for keyword in ["关于", "通知", "办法", "方案", "细则", "规定", "意见"]
            ):
                return line
